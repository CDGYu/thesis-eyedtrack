...
class SignUpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set input type and filters for mobile number (digits only, max 11)
        ...
        // Password visibility is handled by the TextInputLayout's built-in toggle (endIconMode).
        ...
        signupButton.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Confirm") { _, _ ->
                    // Save user data (birthday is no longer collected at registration)
